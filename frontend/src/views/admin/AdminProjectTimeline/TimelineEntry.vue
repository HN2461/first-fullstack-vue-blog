<template>
  <article class="timeline-entry">
    <header class="timeline-entry__head">
      ...
      <div class="timeline-entry__actions">
        ...
        <a-tooltip title="编辑记录">
          <a-button class="timeline-entry__edit" shape="circle" size="small" aria-label="编辑项目记录" @click="$emit('edit', record)">
    ...
    <div class="timeline-entry__detail">
      <p class="timeline-entry__detail-text">{{ record.detail || '-' }}</p>
    </div>
