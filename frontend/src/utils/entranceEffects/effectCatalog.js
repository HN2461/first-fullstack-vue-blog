...
export const ENTRANCE_EFFECT_CATEGORIES = [
  {
    ...
    label: '基础简约',
    effects: [
      { key: 'fade-soft', name: '柔和淡入', tone: '#376b7e' },
      { key: 'float-up', name: '轻浮上升', tone: '#5d7661' },
      { key: 'slide-left', name: '左侧滑入', tone: '#7d6550' },
      { key: 'slide-right', name: '右侧滑入', tone: '#596d8f' },
      { key: 'scale-pop', name: '缩放聚焦', tone: '#866e53' },
      { key: 'flip-3d', name: '三维翻页', tone: '#4f6982' }
    ]
  },
  {
    key: 'particle',
    label: '粒子视觉',
    effects: [
      { key: 'starlight', name: '星光点阵', tone: '#315f86' },
      { key: 'firework-bloom', name: '烟花绽放', tone: '#a35147' },
      { key: 'particle-burst', name: '粒子散开', tone: '#5e5a91' },
      { key: 'ripple', name: '水波扩散', tone: '#2f756f' },
      { key: 'light-sweep', name: '流光扫描', tone: '#7c7246' }
    ]
  },
  {
    key: 'ambient',
    label: '氛围感',
    effects: [
      { key: 'meteor-night', name: '流星夜幕', tone: '#33425d' },
      { key: 'shadow-sweep', name: '光影掠过', tone: '#5d5a4f' },
      { key: 'flash-open', name: '白闪启幕', tone: '#767676' },
      { key: 'curtain', name: '幕布展开', tone: '#7d4c55' }
    ]
  },
  {
    key: 'impact',
    label: '炫酷炸裂',
    effects: [
      { key: 'shatter', name: '碎片破场', tone: '#725166' },
      { key: 'color-burst', name: '色彩爆开', tone: '#986241' },
      { key: 'shockwave', name: '冲击波', tone: '#446a8c' },
      { key: 'screen-shake', name: '屏幕震荡', tone: '#714e45' }
    ]
  },
  {
    key: 'soft',
    label: '轻柔氛围',
    effects: [
      { key: 'petals', name: '花瓣飘落', tone: '#8f5f6b' },
      { key: 'snow', name: '细雪落幕', tone: '#60788f' },
      { key: 'glow', name: '柔光浮现', tone: '#6b784d' },
      { key: 'fog', name: '薄雾散开', tone: '#6c7377' }
    ]
  }
]
