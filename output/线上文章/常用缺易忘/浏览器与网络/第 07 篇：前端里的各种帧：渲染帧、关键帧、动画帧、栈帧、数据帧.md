---
title: "第 7 篇：前端里的各种“帧”：渲染帧、关键帧、动画帧、栈帧、数据帧"
slug: "frame-6e6d3264"
summary: "前端 Frame 概念辨析笔记，系统梳理渲染帧、关键帧、动画帧、调用栈帧、视频帧、iframe、WebSocket 数据帧等不同场景。"
category: "浏览器与网络"
tags: ["Frame","渲染帧","关键帧","动画帧","栈帧","WebSocket"]
status: "draft"
sortOrder: 70
cover: ""
...
---
# 第 7 篇：前端里的各种“帧”：渲染帧、关键帧、动画帧、栈帧、数据帧
