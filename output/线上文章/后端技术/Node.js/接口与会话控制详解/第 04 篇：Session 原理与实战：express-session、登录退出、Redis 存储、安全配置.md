---
title: "第 4 篇：Session 原理与实战：express-session、登录退出、Redis 存储、安全配置"
slug: "node-js-session-9e7c15d4"
summary: "Session 原理与 Express 实战，覆盖 express-session 配置、登录退出、鉴权、Session 存储方式、Redis 持久化和安全配置。"
category: "接口与会话控制详解"
tags:
  - "Node.js"
  - "Session"
...
// 模拟用户数据（实际应查数据库）
const users = [
  { id: 1, username: 'admin', password: '$2b---
title: "第 4 篇：Session 原理与实战：express-session、登录退出、Redis 存储、安全配置"
slug: "node-js-session-9e7c15d4"
summary: "Session 原理与 Express 实战，覆盖 express-session 配置、登录退出、鉴权、Session 存储方式、Redis 持久化和安全配置。"
category: "接口与会话控制详解"
...
---
0$xxx', role: 'admin' },
  { id: 2, username: 'user1', password: '$2b---
title: "第 4 篇：Session 原理与实战：express-session、登录退出、Redis 存储、安全配置"
slug: "node-js-session-9e7c15d4"
summary: "Session 原理与 Express 实战，覆盖 express-session 配置、登录退出、鉴权、Session 存储方式、Redis 持久化和安全配置。"
category: "接口与会话控制详解"
