---
title: "第 3 篇：XPath 解析 HTML 并保存 CSV：lxml、文本提取、属性筛选、urljoin"
slug: "python-crawler-lxml-parse-html-save-csv"
summary: "Python 网络爬虫解析实战，覆盖 lxml、XPath、文本和属性提取、层级定位、多条件筛选、相对 XPath、列表循环、空值安全、urljoin 和 CSV 保存。"
category: "网络爬虫与数据分析"
categoryPath:
  - "后端技术"
  - "Python"
...
updatedAt: "2026-07-31T11:16:21.980Z"
exportedAt: "2026-08-03T03:03:53.296Z"
---
# 第 3 篇：XPath 解析 HTML 并保存 CSV：lxml、文本提取、属性筛选、urljoin
