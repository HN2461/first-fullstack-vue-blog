---
title: "第 04 篇：Codex 多线路接入与迁移总手册"
...
3. 如果后台没开放示例模型，不要硬填
4. 第三方服务商文档、套餐、域名和模型列表变化很快，发布前必须重新核对服务商后台与文档
...
5. 最后再处理高权限、自动化、云任务和长期 profile 文件
