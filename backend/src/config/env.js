...
export const env = Object.freeze({
  ...
  mediaUploadMaxConcurrent: readNumber('MEDIA_UPLOAD_MAX_CONCURRENT', 2),
  mediaUploadMaxTotalMB: readNumber('MEDIA_UPLOAD_MAX_TOTAL_MB', 1024),
  mediaUploadDiskReserveMB: readNumber('MEDIA_UPLOAD_DISK_RESERVE_MB', 2048),
