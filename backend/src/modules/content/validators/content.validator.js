...
export const idBatchSchema = z.object({
  ids: z.array(z.string().regex(objectIdPattern, '记录 id 不正确')).min(1, '请选择要操作的数据')
})

export const articleStatusBatchSchema = idBatchSchema.extend({
...
export const commentReviewBatchSchema = idBatchSchema.extend({
